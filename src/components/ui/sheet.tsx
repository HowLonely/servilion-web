  ...
  return (
    <SheetPrimitive.Portal data-slot="sheet-portal">
      ...
      <SheetPrimitive.Content
        ...
        className={cn(
          "fixed inset-y-0 z-50 flex h-full w-72 max-w-[85vw] flex-col bg-sidebar text-sidebar-foreground shadow-xl duration-200 outline-none data-open:animate-in data-closed:animate-out",
          side === "left"
